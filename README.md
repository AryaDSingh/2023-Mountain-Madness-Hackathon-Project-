User sends a phrase to another user, but the other user receives a the phrase with scrambled words (lost in translation) and using the translator, they are able to decypher the phrase
